module.exports = {
    "Initial Content": function (browser) {
        browser
            ...
            .verify.value("#classNameInput","")
            .verify.containsText("#error","")
            .verify.containsText("#selectStatement>h1","Please Select A Class To View Their TimeTable")
            .end();
    },
    "Checking Class List and added class time table": function (browser) {
        browser
            ...
            //tbody
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(1)","")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(2)>strong","")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(5)>strong","")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(7)>p","")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(9)>p","")
            .verify.containsText("table>tbody>tr>td:nth-of-type(4)","Break")
            .verify.containsText("table>tbody>tr>td:nth-of-type(7)","Lunch")
            .verify.attributeContains("table>tbody>tr>td:nth-of-type(7)","rowSpan","5")
            .verify.attributeContains("table>tbody>tr>td:nth-of-type(10)","rowSpan","5")
    ...
    "Check Class 1":function(browser){
        browser
            ...
            .verify.containsText("table>tbody>tr>td:nth-of-type(11)>strong","Geography")
            .verify.containsText("table>tbody>tr>td:nth-of-type(12)>p","Monica")

            //tbody
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(1)","Wednesday")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(2)>strong","English")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(2)>p","Anu")
            
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(4)>strong","Art")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(4)>p","Monica")
            
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(8)>strong","History")
            .verify.containsText("table>tbody>tr:nth-of-type(3)>td:nth-of-type(9)>p","Ross")

            .verify.containsText("table>tbody>tr:nth-of-type(5)>td:nth-of-type(1)","Friday")
            .verify.containsText("table>tbody>tr:nth-of-type(5)>td:nth-of-type(8)>strong","")
            .verify.containsText("table>tbody>tr:nth-of-type(5)>td:nth-of-type(9)>p","")
